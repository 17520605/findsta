...
@section('content')
    ...
    <div class="head-title">
        <span class="cat-title" style="background-color: #000000;"><i class=" fa-solid fa-image"></i> Images <div class="follow-tc nfllowing" data-id="3" data-type="cat" onclick="return followTc(this);"><i class="fas fa-plus fa-lg"></i> <span>Follow</span></div></span>
    </div>
                                ...
                                <div class="box king-q-list-item" id="q{{ $list->id }}">
                                    ...
                                    <div class="king-q-item-main">
                                        <a class="item-a"
                                            ...
                                            <span class="post-featured-img"><img class="item-img king-lazy" width="800" height="auto" style="max-height: 500px" data-king-img-src="{{ $list->thumbnail }}" alt="" /></span>
                                        </a>
