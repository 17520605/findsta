...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    .button--green {
      ...
      border-top: 10px solid #e60023;
      border-right: 18px solid #e60023;
      border-bottom: 10px solid #e60023;
      border-left: 18px solid #e60023;
    }
                          ...
                          <tr>
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="{{$route}}" style="color: #FFF;font-size: 14px" class="f-fallback button button--green" target="_blank">Reset your password</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
