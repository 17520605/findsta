@section('title', 'CryptoNews Following')
        ...
        <div class="user-box">
            <div class="user-box-pt">
                <div class="user-box-cover">
                    <div data-king-img-src="https://res.cloudinary.com/dsldtailo/image/upload/v1670949819/cryptonexnews/default/happy-new-year-2023-background-with-minimal-red-line_1361-4043.webp_qmvgim.png" class="king-box-bg"></div>
    ...
    <div id="king-body-wrapper" class="king-body-in">
        <ul class="king-nav-sub-list">
            ...
            <li class="king-nav-sub-item king-nav-sub-following">
                <a href="{{ route('user.get.following')}}" class="king-nav-sub-link king-nav-sub-selected">{{__('info_following')}}</a>
            </li>
        </ul>
