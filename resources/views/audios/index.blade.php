...
@section('content')
    ...
    <div class="head-title">
        <span class="cat-title" style="background-color: #000000;"><i class="fa-solid fa-headphones"></i> Audios <div class="follow-tc nfllowing" data-id="3" data-type="cat" onclick="return followTc(this);"><i class="fas fa-plus fa-lg"></i> <span>Follow</span></div></span>
    </div>
