...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : ((t =
              "undefined" != typeof globalThis
                  ? globalThis
                  : t || self).videojsPlaylistUi = e(t.videojs));
})(this, function (t) {
    "use strict";
    function e(t) {
    ...
    const i = s.default.dom || s.default,
        ...
        o = function (t) {
            t.removeClass("vjs-selected"),
                t.thumbnail &&
                    i.removeClass(t.thumbnail, "vjs-playlist-now-playing");
        },
        r = function (t) {
        ...
        createEl() {
            ...
            if (
                ...
                (this.thumbnail = (function (t) {
                    ...
                    if (
                        ((e.className = "vjs-playlist-thumbnail"),
                        "string" == typeof t)
                    ) {
                        const s = document.createElement("img");
                        (s.src = t), (s.alt = ""), e.appendChild(s);
                    } else {
                        for (let s = 0; s < t.length - 1; s++) {
                            const i = t[s],
                                l = document.createElement("source");
                            for (const t in i) l[t] = i[t];
                            e.appendChild(l);
                        }
    ...
    class p extends d {
        constructor(t, e) {
            ...
            super(t, e),
                ...
                this.on("dispose", () => {
                    this.empty_(), (t.playlistMenu = null);
                }),
                this.on(t, "dispose", () => {
                    this.dispose();
                });
        ...
        createEl() {
            return i.createEl("div", { className: this.options_.className });
        }
        empty_() {
            this.items &&
                this.items.length &&
                (this.items.forEach((t) => t.dispose()),
                (this.items.length = 0));
        }
        createPlaylist_() {
            ...
            for (let s = 0; s < t.length; s++) {
                const i = new c(this.player_, { item: t[s] }, this.options_);
                this.items.push(i), e.appendChild(i.el_);
            }
            s ||
        ...
        update() {
            ...
            for (let t = 0; t < this.items.length; t++) {
                ...
                t === e
                    ? (a(s),
                      document.activeElement !== s.el() &&
                          i.addClass(s.thumbnail, "vjs-playlist-now-playing"),
                      r(s))
                    : t === e + 1
                    ? (o(s), s.addClass("vjs-up-next"))
                    : (o(s), r(s));
            }
        }
    }
    const h = (t) => {
            for (let e = 0; e < t.childNodes.length; e++)
                if (i.isEl(t.childNodes[e])) return !0;
            return !1;
        },
        u = function (t) {
            const e = this;
    ...
    return (
        s.default.registerComponent("PlaylistMenu", p),
