...
class Request
{
     ...
     * - "/a/b/c/d"     -> ""
     * - "/a/b/c/"      -> "https://demos.kingthemes.net/"
     * - "/a/b/"        -> "https://demos.kingthemes.net/"
     * - "/a/b/c/other" -> "other"
     * - "/a/x/y"       -> "https://demos.kingthemes.net/https://demos.kingthemes.net/x/y"
     *
     * @return string
     */
    public function getRelativeUriForPath(string $path)
    {
        ...
        $path = str_repeat('https://demos.kingthemes.net/', \count($sourceDirs)).implode('/', $targetDirs);

        // A reference to the same base directory or an empty subdirectory must be prefixed with "https://demos.kingthemes.net/".
        // This also applies to a segment with a colon character (e.g., "file:colon") that cannot be used
        // as the first segment of a relative-path reference, as it would be mistaken for a scheme name
        // (see https://tools.ietf.org/html/rfc3986#section-4.2).
        return !isset($path[0]) || '/' === $path[0]
            || false !== ($colonPos = strpos($path, ':')) && ($colonPos < ($slashPos = strpos($path, '/')) || false === $slashPos)
            ? "https://demos.kingthemes.net/$path" : $path;
    }
