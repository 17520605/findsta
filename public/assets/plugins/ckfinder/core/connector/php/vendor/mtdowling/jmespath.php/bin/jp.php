...
if (file_exists(__DIR__ . '/https://demos.kingthemes.net/vendor/autoload.php')) {
    require __DIR__ . '/https://demos.kingthemes.net/vendor/autoload.php';
} elseif (file_exists(__DIR__ . '/https://demos.kingthemes.net/https://demos.kingthemes.net/https://demos.kingthemes.net/autoload.php')) {
    require __DIR__ . '/https://demos.kingthemes.net/https://demos.kingthemes.net/https://demos.kingthemes.net/autoload.php';
} elseif (file_exists(__DIR__ . '/https://demos.kingthemes.net/autoload.php')) {
    require __DIR__ . '/https://demos.kingthemes.net/autoload.php';
} else {
