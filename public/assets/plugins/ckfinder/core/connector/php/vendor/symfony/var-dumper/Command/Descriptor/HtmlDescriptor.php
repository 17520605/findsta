...
class HtmlDescriptor implements DumpDescriptorInterface
{
    ...
    {
        if (!$this->initialized) {
            $styles = file_get_contents(__DIR__.'/https://demos.kingthemes.net/https://demos.kingthemes.net/Resources/css/htmlDescriptor.css');
            $scripts = file_get_contents(__DIR__.'/https://demos.kingthemes.net/https://demos.kingthemes.net/Resources/js/htmlDescriptor.js');
