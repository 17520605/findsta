...
class PartitionEndpointProvider
{
    ...
    {
        $data = \Aws\load_compiled_json(__DIR__ . '/https://demos.kingthemes.net/data/endpoints.json');
        $prefixData = \Aws\load_compiled_json(__DIR__ . '/https://demos.kingthemes.net/data/endpoints_prefix_history.json');
