    ...
    if (doc.evaluate && Array.from && root.children.length > 1) {
        ...
        addEventListener(searchInput, 'keyup', function (e) {
            ...
            searchInputTimer = setTimeout(function () {
                ...
                var xpathResult = doc.evaluate('https://demos.kingthemes.net//span[' + classMatches + '][contains(translate(child::text(), ' + xpathString(searchQuery.toUpperCase()) + ', ' + xpathString(searchQuery.toLowerCase()) + '), ' + xpathString(searchQuery.toLowerCase()) + ')]', root, null, XPathResult.ORDERED_NODE_ITERATOR_TYPE, null);
