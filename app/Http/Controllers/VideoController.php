...
class VideoController extends Controller
{
    public function index()
    {
        ...
        {
            //['lang', $lang],
            $lists = \App\Models\Blogs::where([['is_public',1],['type','video']])->orderby('id', 'DESC')->get();
        }
        else
        {
            $lang = 'en';
        ...
        return view('videos.index', ['categories'=>$categories, 'lists'=>$lists, 'topvideos'=>$topvideos, 'count_bookmarks'=>$count_bookmarks]);
    }
}
