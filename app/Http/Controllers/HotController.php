...
class HotController extends Controller
{
    public function index()
    {
        ...
        {
            //['lang', $lang],
            $lists = \App\Models\Blogs::where([['is_public',1],['type','image']])->orderby('id', 'DESC')->offset(0)->limit(15)->get();
        }
        else
        {
            $lang = 'en';
        ...
        return view('hot.index', ['categories'=>$categories, 'lists'=>$lists, 'topvideos'=>$topvideos,'count_bookmarks'=>$count_bookmarks]);
    }
}
