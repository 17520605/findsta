...
class ImageController extends Controller
{
    public function index()
    {
        ...
        {
            //['lang', $lang],
            $lists = \App\Models\Blogs::where([['is_public',1],['type','image']])->orderby('id', 'DESC')->get();
        }
        else
        {
            $lang = 'en';
        ...
        return view('images.index', ['categories'=>$categories, 'lists'=>$lists, 'topvideos'=>$topvideos, 'count_bookmarks'=>$count_bookmarks]);
    }
}
